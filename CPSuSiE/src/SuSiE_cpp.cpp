...
// [[Rcpp::export]]
Rcpp::List SuSiE_group(arma::vec y,arma::mat X1,arma::mat X2,double L,double f=1, double sigma2=0,double delta=0.001,int maxIt=100) {
  ...
  if (sigma2 > 0) {
    if (L > 0) {
      ...
      arma::mat Sigma_q_beta2 = zeros(p,L);
      arma::mat Alpha = zeros(p,L);
      double mu_q_sigma2 = sigma2;
      double mu_q_sigma2inv = 1/sigma2;
